...
class InboundContextImpl(H) : ContextImplBase!(H, InboundHandlerContext!(H.rout)),
InboundHandlerContext!(H.rout),InboundLink!(H.rin)
{
...
class OutboundContextImpl(H) : ContextImplBase!(H, OutboundHandlerContext!(H.wout)),
	OutboundHandlerContext!(H.wout),OutboundLink!(H.win)
{
