...
class Frame
{
	...
	@property opCode() const {return _opCode;}
	@property isFinalFrame() const {return _isFinalFrame;}
	@property closeCode() const {return _closeCode;}
	@property closeReason() {return _closeReason;}
	@property rsv1() const { return _rsv1; }
	@property rsv2() const { return _rsv2; }
	@property rsv3() const { return _rsv3; }
	@property isValid() const {return _isValid;}
...
protected:
	...
	{
		return ((code > OpCode.OpCodeBinary) && (code < OpCode.OpCodeClose)) || (code > OpCode.OpCodePong);
	}
	...
	bool checkValidity()
	{
		...
		if (frame._rsv1 || frame._rsv2 || frame._rsv3) {
			...
			if (_length > 125) {
				setError(CloseCode.CloseCodeProtocolError,
