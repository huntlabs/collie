...
__gshared static const string[33] error_string = [
	"success"//ok
	/* Callback-related errors */    
...
__gshared static const char[256] tokens = [
...
__gshared static const byte[256] unhex =
...
version (HTTP_PARSER_STRICT) {
	ubyte T(ubyte v){ return 0;}
} else {
	ubyte T(ubyte v){return  v;}
}


__gshared  const ubyte[32] normal_url_char = [
	/*   0 nul    1 soh    2 stx    3 etx    4 eot    5 enq    6 ack    7 bel  */
	0    |   0    |   0    |   0    |   0    |   0    |   0    |   0,
	/*   8 bs     9 ht    10 nl    11 vt    12 np    13 cr    14 so    15 si   */
